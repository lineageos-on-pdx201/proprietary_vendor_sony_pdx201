...
for (offset = 0; offset < 2; offset++) {
    float4 pow_tmp;
    pow_tmp.s0 = native_powr((data[offset].s0 * max_fusion_input_val_r), hdr_bayer_gtm_gamma);
    pow_tmp.s1 = native_powr((data[offset].s1 * max_fusion_input_val_r), hdr_bayer_gtm_gamma);
    pow_tmp.s2 = native_powr((data[offset].s2 * max_fusion_input_val_r), hdr_bayer_gtm_gamma);
    pow_tmp.s3 = native_powr((data[offset].s3 * max_fusion_input_val_r), hdr_bayer_gtm_gamma);

    luma_q0.s0 = pow_tmp.s0 * max_fusion_input_val;
    luma_q0.s1 = pow_tmp.s1 * max_fusion_input_val;
    luma_q0.s2 = pow_tmp.s2 * max_fusion_input_val;
    luma_q0.s3 = pow_tmp.s3 * max_fusion_input_val;
    ...
    diff[2] = fabs(lp - luma_q0.s2);
    diff[3] = fabs(lp - luma_q0.s3);

    float4 local_th;
    local_th = luma_q0;

    diff[0] = min(local_th.s0, diff[0]);
    diff[1] = min(local_th.s1, diff[1]);
    diff[2] = min(local_th.s2, diff[2]);
    diff[3] = min(local_th.s3, diff[3]);

    local_th += ONE;

    diff[0] = local_th.s0 - diff[0];
    diff[1] = local_th.s1 - diff[1];
    diff[2] = local_th.s2 - diff[2];
    diff[3] = local_th.s3 - diff[3];

    diff[0] = native_sqrt(diff[0]);
    diff[1] = native_sqrt(diff[1]);
    diff[2] = native_sqrt(diff[2]);
    diff[3] = native_sqrt(diff[3]);
    ...
    wt_sm.s2 = diff[2].s0 + diff[2].s1 + diff[2].s2 + diff[2].s3 + diff[2].s4 + diff[2].s5 +
               diff[2].s6 + diff[2].s7 + diff[2].s8 + diff[2].s9 + diff[2].sa + diff[2].sb +
               diff[2].sc + diff[2].sd + diff[2].se + diff[2].sf;
    wt_sm.s3 = diff[3].s0 + diff[3].s1 + diff[3].s2 + diff[3].s3 + diff[3].s4 + diff[3].s5 +
               diff[3].s6 + diff[3].s7 + diff[3].s8 + diff[3].s9 + diff[3].sa + diff[3].sb +
               diff[3].sc + diff[3].sd + diff[3].se + diff[3].sf;
    ...
    data[offset].s0 = diff[0].s0 + diff[0].s1 + diff[0].s2 + diff[0].s3 + diff[0].s4 +
                      diff[0].s5 + diff[0].s6 + diff[0].s7 + diff[0].s8 + diff[0].s9 +
                      diff[0].sa + diff[0].sb + diff[0].sc + diff[0].sd + diff[0].se +
                      diff[0].sf;
    data[offset].s1 = diff[1].s0 + diff[1].s1 + diff[1].s2 + diff[1].s3 + diff[1].s4 +
                      diff[1].s5 + diff[1].s6 + diff[1].s7 + diff[1].s8 + diff[1].s9 +
                      diff[1].sa + diff[1].sb + diff[1].sc + diff[1].sd + diff[1].se +
                      diff[1].sf;
    data[offset].s2 = diff[2].s0 + diff[2].s1 + diff[2].s2 + diff[2].s3 + diff[2].s4 +
                      diff[2].s5 + diff[2].s6 + diff[2].s7 + diff[2].s8 + diff[2].s9 +
                      diff[2].sa + diff[2].sb + diff[2].sc + diff[2].sd + diff[2].se +
                      diff[2].sf;
    data[offset].s3 = diff[3].s0 + diff[3].s1 + diff[3].s2 + diff[3].s3 + diff[3].s4 +
                      diff[3].s5 + diff[3].s6 + diff[3].s7 + diff[3].s8 + diff[3].s9 +
                      diff[3].sa + diff[3].sb + diff[3].sc + diff[3].sd + diff[3].se +
                      diff[3].sf;

    //data[offset] /= wt_sm;
    data[offset] = native_divide(data[offset], wt_sm);

    float4 lp_total;
    lp_total.s0 = max(data[offset].s0, ONE);
    lp_total.s1 = max(data[offset].s1, ONE);
    lp_total.s2 = max(data[offset].s2, ONE);
    lp_total.s3 = max(data[offset].s3, ONE);

    float K1 = comp_target_div_by_2 * TWO;
    float K2 = K1 * TWO;

    data[offset].s0 = isless(lp_total.s0, K1) * (lp_total.s0 + comp_target_div_by_2) + isgreater(lp_total.s0, K2) * lp_total.s0;
    data[offset].s1 = isless(lp_total.s1, K1) * (lp_total.s1 + comp_target_div_by_2) + isgreater(lp_total.s1, K2) * lp_total.s1;
    data[offset].s2 = isless(lp_total.s2, K1) * (lp_total.s2 + comp_target_div_by_2) + isgreater(lp_total.s2, K2) * lp_total.s2;
    data[offset].s3 = isless(lp_total.s3, K1) * (lp_total.s3 + comp_target_div_by_2) + isgreater(lp_total.s3, K2) * lp_total.s3;

    data[offset].s0 += isequal(data[offset].s0, ZERO) * (comp_target_div_by_2 * TWO + lp_total.s0 / TWO);
    data[offset].s1 += isequal(data[offset].s1, ZERO) * (comp_target_div_by_2 * TWO + lp_total.s1 / TWO);
    data[offset].s2 += isequal(data[offset].s2, ZERO) * (comp_target_div_by_2 * TWO + lp_total.s2 / TWO);
    data[offset].s3 += isequal(data[offset].s3, ZERO) * (comp_target_div_by_2 * TWO + lp_total.s3 / TWO);

    //data[offset] /= lp_total;
    data[offset] = native_divide(data[offset], lp_total);

    data[offset].s0 = clamp(data[offset].s0, ONE, max_gain);
    data[offset].s1 = clamp(data[offset].s1, ONE, max_gain);
    data[offset].s2 = clamp(data[offset].s2, ONE, max_gain);
    data[offset].s3 = clamp(data[offset].s3, ONE, max_gain);
    ...
    luma_q0.s2 = TWO - clamp(luma_q0.s2, inverse_tone_perc, K2) * inverse_tone_perc_r;
    luma_q0.s3 = TWO - clamp(luma_q0.s3, inverse_tone_perc, K2) * inverse_tone_perc_r;

    data[offset].s0 = data[offset].s0 * luma_q0.s0 + ONE - luma_q0.s0;
    data[offset].s1 = data[offset].s1 * luma_q0.s1 + ONE - luma_q0.s1;
    data[offset].s2 = data[offset].s2 * luma_q0.s2 + ONE - luma_q0.s2;
    data[offset].s3 = data[offset].s3 * luma_q0.s3 + ONE - luma_q0.s3;
#endif
    data[offset].s0 = data[offset].s0 * pow_tmp.s0 * max_tm_output_val;
    data[offset].s1 = data[offset].s1 * pow_tmp.s1 * max_tm_output_val;
    data[offset].s2 = data[offset].s2 * pow_tmp.s2 * max_tm_output_val;
    data[offset].s3 = data[offset].s3 * pow_tmp.s3 * max_tm_output_val;
  }
